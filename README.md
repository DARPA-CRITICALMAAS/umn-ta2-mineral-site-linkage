...
* The data dictionary must consist of pairs of descriptions and attribute names in the database.
    ...
    * Data dictionaries are usually available inside the compressed zip data file (e.g., 'Data_Dictionary.csv' for [USMIN](https://www.sciencebase.gov/catalog/file/get/5ad623f2e4b0e2c2dd23f09e?name=USGS_Cobalt_US_CSV.zip)).
