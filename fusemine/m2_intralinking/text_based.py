...
def create_relevant_embeddings(alias_code:str, dict_known:dict):
...
def text_based_linking(pl_loclinked, alias_code:str, dict_known:dict):
    pl_embeddings = create_relevant_embeddings(alias_code, dict_known)
